...
public class FloatOver extends CordovaPlugin {
	...
	final CallbackContext callbackContext) throws JSONException {
		...
		return true;
			    ...
			    //Intent stopServiceIntent = new Intent(activity, FloatOverService.class);
			    //stopServiceIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
			    //stopServiceIntent.setAction(FloatOverService.ACTION_STOP_SERVICE);
