...
var filestoreplace = [
    "platforms/android/app/src/main/java/org/apache/cordova/floatOver/Services/FloatOverService.java"
];
filestoreplace.forEach(function(val, index, array) {
    if (fs.existsSync(val)) {
        ...
        replace_string_in_file(val,"import org.apache.cordova.floatOver.GeneralUtils.KeyDispatchLayout;","import org.apache.cordova.floatOver.GeneralUtils.KeyDispatchLayout;\n\nimport "+packageName+".R;");
    } else {
